...
# os module gets the IP module if it exists and sets 0.0.0.0 if it dosen't 
# exist
# doing the same with port, using the 5000 as this is the common one used by 
# flask
# setting debug to True to help with our debug, this is should be set for 
# production code or submitting project
